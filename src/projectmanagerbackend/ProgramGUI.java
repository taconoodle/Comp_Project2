...
public class ProgramGUI implements Serializable {
    private int pID;
    private int pCores;
    private int pRam;
    ...
    protected ProgramGUI(int cores, int ram, int diskSpace, int gpu, int bandwidth, int expectedTime, double priority) {
