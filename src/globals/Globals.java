...
public class Globals {
    ...
    public static enum OperatingSystems {   //the supported operating systems
        WINDOWS,
        UBUNTU,
        FEDORA
    }
    public static float MIN_BANDWIDTH_PER_VM = 4;   //the minimum amount of bandwidth the VM should get
}
